...
export const ChatHeader: React.FC<ChatHeaderProps> = ({
  ...
  return (
    <div className="flex justify-between items-center border px-10 py-3 border-gray-300 dark:border-[#362B2B] bg-white dark:bg-[#171212] max-md:px-6 max-md:py-3 max-sm:px-4 max-sm:py-3">
      ...
      <div className="flex justify-end items-center gap-8 flex-1 max-md:gap-4">
        {selectedMovie && (
          <div className="flex h-8 justify-center items-center gap-2 bg-gray-200 dark:bg-[#362B2B] px-4 py-0 rounded-xl max-sm:px-3 max-sm:py-0">
